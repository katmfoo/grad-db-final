...
$sql = "UPDATE product SET name = '".$name."', list_price = '".$list_price."', supplier_id = '".$supplier_id."', minimum_stock = '".$minimum_stock."', current_stock = '".$current_stock."' WHERE product_id = ".$product_id;
