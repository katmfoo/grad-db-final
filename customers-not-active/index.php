...
$sql = "SELECT *, (
        ...
        FROM richealp7.customer
        WHERE is_deleted = 0
        HAVING last_order_date < DATE_SUB(NOW(), INTERVAL 1 MONTH) OR last_order_date IS NULL ORDER BY last_order_date ASC, creation_datetime ASC LIMIT $_ITEMS_PER_PAGE OFFSET $offset";
...
echo $twig->render('customers_not_active.html', array('customers' => $customers, 'page' => $page, 'page_size' => $_ITEMS_PER_PAGE));
